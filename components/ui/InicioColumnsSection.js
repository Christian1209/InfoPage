...
export const InicioColumnsSection = () => {
  return (
    <section className='bg-dark text-white py-4 px-5'>
        <div className='my-4 px-4'>
            <Row>
                <Col sm = {12} md = {6} xl = {4}>
                    <img src="/assets/inicio/uva.jpg" className='mb-4 img-fluid' alt='uva' width='441' height='248' loading='lazy'/> 
